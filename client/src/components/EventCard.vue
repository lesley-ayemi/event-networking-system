<template>
  <div class="h-full bg-white shadow-sm ring-1 ring-gray-100 rounded-xl overflow-hidden flex flex-col">
    <img v-if="event.cover_image" :src="event.cover_image" alt="" class="w-full h-32 object-cover" />
